...
<div className="info">
        <p >
          We try and make people feel like family as quick as possible, and help
          get them acclimated to our project.
        </p>
...
<p>
        ...
        <h3>
          Rockstar Games, Inc. is an video game publisher based in New York
          City.
        </h3>
        ...
        <h4>
          Founding members of the company were Sam and Dan Houser, Terry Donovan
          and Jamie King, who worked for Take-Two at the time, and of which the
          Houser brothers were previously executives at BMG Interactive. Sam
          Houser heads the studio as president.
        </h4>

        <img src="https://wallpapercave.com/wp/wp9686529.jpg" alt="" />

        <h1>
          In 2006, as part of testing its new RAGE engine ahead of GTA IV and
          RDR.
        </h1>
        ...
        <h2>
          Rockstar started working with DMA on GTA 2, which was supposed to get
          better, bigger and harder. Rockstar sterte working with DMA on GTA 2,
          which was supposed to get better, bigger and harder.
        </h2>

        <h2>
          After several successful (but not profitable) successful projects that
          broke the mold, Rockstar Games is back to its roots and greatest
          treasure, the GTA franchise. In 2013, Grand Theft Auto V was released.
        </h2>
      </div>
      <Footer />
    </>
